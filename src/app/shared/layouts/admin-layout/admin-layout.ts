...
const NAV_ITEMS: readonly NavItem[] = [
  { path: '/admin/dashboard', label: 'Inicio', icon: 'pi pi-home' },
  { path: '/admin/sales', label: 'Ventas', icon: 'pi pi-shopping-cart' },
  { path: '/admin/settlements', label: 'Liquidaciones', icon: 'pi pi-wallet' },
  { path: '/admin/inventory', label: 'Inventario', icon: 'pi pi-box' },
  { path: '/admin/reports', label: 'Centro de Reportes', icon: 'pi pi-chart-bar' },
  { path: '/admin/tasks', label: 'Tareas', icon: 'pi pi-check-square' },
  { path: '/admin/settings', label: 'Configuración', icon: 'pi pi-cog' }
];
      ...
      <div class="flex-1 flex flex-col min-w-0">
        ...
        >
          <div class="text-right">
            ...
            <div class="text-xs text-surface-500 dark:text-surface-400">Admin</div>
          </div>
          <button
            pButton
            icon="pi pi-sign-out"
